...
class DetailScreenMakanan extends StatelessWidget {
  final Makanan makanan;

  const DetailScreenMakanan({Key key, this.makanan}) : super(key: key);
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            DetaiIconDurasi(makanan: makanan),
                            DetaiIconPorsi(makanan: makanan),
                            DetaiIconKalori(makanan: makanan),
                            DetaiIconLevel(makanan: makanan)
                          ],
                        ),
                      ),
                      SizedBox(
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Column(
                        children: [
                          for (int i = 0; i < makanan.bahan.length; i++)
                            Padding(
                  ...
                  child: SizedBox(
                    child: Column(
                      children: [
                        ...
                        Column(
                          children: [
                            for (int i = 0; i < makanan.langkah.length; i++)
                              Padding(
                                padding: EdgeInsets.only(bottom: 10),
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
