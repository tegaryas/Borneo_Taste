...
class DetailScreenLain extends StatelessWidget {
  final Lain lain;

  const DetailScreenLain({Key key, this.lain}) : super(key: key);
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            DetaiIconDurasi(lain: lain),
                            DetaiIconPorsi(lain: lain),
                            DetaiIconKalori(lain: lain),
                            DetaiIconLevel(lain: lain)
                          ],
                        ),
                      ),
                      SizedBox(
                ...
                Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Column(
                        children: [
                          for (int i = 0; i < lain.bahan.length; i++)
                            Padding(
                  ...
                  child: SizedBox(
                    child: Column(
                      children: [
                        ...
                        Column(
                          children: [
                            for (int i = 0; i < lain.langkah.length; i++)
                              Padding(
                                padding: EdgeInsets.only(bottom: 10),
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
